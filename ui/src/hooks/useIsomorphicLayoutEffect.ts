 ...
 *
 * That means this hook is a browser hook.
 * But React code could be generated from the server without the Window API.
 ...
 * To avoid this, useLayoutEffect should only be used in components that render exclusively on the
