...
import { SpectrumAnalyzerBox, SpectrumAnalyzerController } from '#components';
...
const SpectrumAnalyzerGrid = () => {
  ...
  return (
    <>
      ...
      {isConfigOpen ? (
        <SpectrumAnalyzerController currentSpecAnalyzer={currentSpecAnalyzer} handleBackgroundClick={handleBackgroundClick} />
      ) : null}
    </>
  );
};
