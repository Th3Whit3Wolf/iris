...
const yellowButtonStyle = {
  ...
  '&:hover': {
    // backgroundColor: theme.palette.warning.Lighten2,
  },
  color: 'black',
...
const SpectrumAnalyzerController = props => {
                ...
                <Grid item xs={12}>
                  <Button
                    sx={{
                      ...
                      ...{
                        // background:
                        //   numberSelection === 'ghz' ? theme.palette.normal.main : theme.palette.warning.main,
                      },
                    }}
                ...
                <Grid item xs={12}>
                  <Button
                    sx={{
                      ...
                      ...{
                        // background:
                        //   numberSelection === 'mhz' ? theme.palette.normal.main : theme.palette.warning.main,
                      },
                    }}
                ...
                <Grid item xs={12}>
                  <Button
                    sx={{
                      ...
                      ...{
                        // background:
                        //   numberSelection === 'khz' ? theme.palette.normal.main : theme.palette.warning.main,
                      },
                    }}
          ...
          <Grid container item sx={{ rowGap: '10px', padding: '20px' }} xs={2}>
            <Grid item xs={12}>
              <Button
                sx={{
                  ...
                  ...{
                    // background:
                    //   controlSelection === 'freq' ? theme.palette.normal.main : theme.palette.warning.main,
                  },
                }}
            ...
            <Grid item xs={12}>
              <Button
                sx={{
                  ...
                  ...{
                    // background:
                    //   controlSelection === 'span' ? theme.palette.normal.main : theme.palette.warning.main,
                  },
                }}
            ...
            <Grid item xs={12}>
              <Button
                sx={{
                  ...yellowButtonStyle,
                  // ...{ background: isTraceOn ? theme.palette.critical.main : theme.palette.warning.main },
                }}
            ...
            <Grid item xs={12}>
              <Button
                sx={{
                  ...yellowButtonStyle,
                  // ...{ background: isMarkerOn ? theme.palette.critical.main : theme.palette.warning.main },
                }}
...
export default SpectrumAnalyzerController;