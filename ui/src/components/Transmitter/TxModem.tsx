...
const TxModem = ({ unit }) => {
  ...
  const unitData = tx.filter(x => x.unit == unit && x.team_id == user.team_id && x.server_id == user.server_id)
  ...
  const TxModemInput = () => {
    ...
    const currentRow = tx.map(x => x.id).indexOf(unitData[currentModem].id);
    ...
    return (
      <Box sx={sxInputBox}>
        ...
        <Box sx={sxInputRow}>
          ...
          <Typography sx={sxValues}>{tx[currentRow].frequency + ' MHz'}</Typography>
        </Box>
        <Box sx={sxInputRow}>
          ...
          <Typography sx={sxValues}>{tx[currentRow].bandwidth + ' MHz'}</Typography>
        </Box>
        <Box sx={sxInputRow}>
          ...
          <Typography sx={sxValues}>{`${tx[currentRow].power} dBm`}</Typography>
        </Box>
        <Box sx={sxInputRow}>
